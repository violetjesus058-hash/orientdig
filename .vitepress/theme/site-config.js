// ============================================================
// Orientdig Spreadsheet Site Configuration
...
export const siteConfig = {
  ...
  // ---- Brand ----
  brand: {
    name: 'Orientdig Spreadsheet',
    tagline: 'Fashion Finds Resource & Buying Guide',
    description: 'Independent resource for Orientdig Spreadsheet shoppers. Product guides, category breakdowns, sizing tips, and spreadsheet access — organized in one place.',
    primaryColor: '#8B0000',
    accentColor: '#d4af37',
    logoText: 'Orientdig Spreadsheet',
  },
  ...
  categories: [
    {
      id: 'clothes',
      name: 'Orientdig Clothing Spreadsheet',
      icon: '',
    ...
    {
      id: 'shoes',
      name: 'Orientdig Shoes Spreadsheet',
      icon: '',
    ...
    {
      id: 'pants',
      name: 'Orientdig Pants Spreadsheet',
      icon: '',
    ...
    {
      id: 'hats',
      name: 'Orientdig Hats Spreadsheet',
      icon: '',
    ...
    {
      id: 'accessories',
      name: 'Orientdig Accessories Spreadsheet',
      icon: '',
    ...
    {
      id: 'electronics',
      name: 'Orientdig Electronics Spreadsheet',
      icon: '',
