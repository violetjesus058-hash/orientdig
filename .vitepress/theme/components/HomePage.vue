  ...
  <main class="modern-home">
    <section class="hero-section">
      <div class="page-container hero-content">
        ...
        <h1>Orientdig Spreadsheet <span>2026</span></h1>
        <p class="hero-copy">
          Discover organized Orientdig finds across clothing, shoes, pants, hats, accessories and electronics,
        ...
        <div class="hero-actions">
          <div class="cta-preview-wrap cta-preview-spreadsheet">
            <div class="cta-preview-card" aria-hidden="true">
              <img src="/images/orientdig-spreadsheet-preview.png" alt="Orientdig Spreadsheet preview showing curated product categories and shopping links" title="Orientdig Spreadsheet preview" />
          ...
          <div class="cta-preview-wrap cta-preview-shopping">
            <div class="cta-preview-card" aria-hidden="true">
              <img src="/images/orientdig-shopping-preview.png" alt="Orientdig shopping preview showing product categories and item options" title="Orientdig shopping preview" />
    ...
    <section id="essential-guides" class="section section-muted essential-guides">
      <div class="page-container">
        <div class="section-heading section-heading-left guides-heading">
          ...
          <p>New to Orientdig? These short guides explain how the platform works, what the spreadsheet is for and how to begin with a clearer plan.</p>
        </div>
    ...
    <section id="community-research" class="section section-research">
      <div class="page-container research-card">
        <div>
          <p class="section-kicker">Policy verification</p>
          <h2>Verify shipping, warehouse and reimbursement policies.</h2>
          <p class="research-card-copy">A conservative Orientdig research path helps you compare current shipping lines, chargeable-weight rules, warehouse stages, delivery evidence and reimbursement questions.</p>
          <a href="/blog/orientdig-community-buying-guide/" class="research-card-link">Read the Orientdig research guide <span aria-hidden="true">→</span></a>
        </div>
        <div class="research-card-note">
          <strong>Orientdig community research</strong>
...
const guideCards = [
  {
    ...
    title: 'How to Buy with Orientdig',
  ...
  },
  {
    ...
    title: 'What Is the Orientdig Spreadsheet?',
  ...
  {
    label: 'Why it helps',
    title: 'Key Benefits of Orientdig',
