...
export default defineConfig({
  ...
  head: [
    ...
    ['script', { async: '', src: 'https://www.googletagmanager.com/gtag/js?id=G-296B05BMXV' }],
    ['script', {}, `
      window.dataLayer = window.dataLayer || [];
      function gtag(){dataLayer.push(arguments);}
      gtag('js', new Date());
      gtag('config', 'G-296B05BMXV');
    `],
  ...
  srcExclude: [
    ...
    'blog/orientdig-article-prompt.md',
    'blog/orientdig-internal-link-rules.md',
    'blog/orientdig-product-reference.md',
    'blog/orientdig-review-report.md',
    'blog/orientdig-topic-list.md',
