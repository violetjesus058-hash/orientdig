...
| 禁止词汇 | 错误示例 | 正确替代 |
|---------|---------|---------|
| shopping agent | "Orientdig Spreadsheet is a shopping agent" | "product directory" / "product discovery resource" |
...
| support staff | "Orientdig Spreadsheet support staff" | （删除） |
